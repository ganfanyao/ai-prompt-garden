...
> 这不是工具库，是给普通人的第一座花园。
>
> 你不需要懂代码，不需要背指令，只需要问一句：
> *"你想写一首关于什么的诗？春天、离别、还是今天窗外的云？"*
>
> 这里有 5 个开箱即用的提示词模板，3 个极简调用脚本，和一颗愿意陪你慢慢长大的心。
> ——因为最好的 AI，不该是冷冰冰的引擎，而是你伸手就能摘到的第一朵花。

**AI Prompt Garden** 是一个面向普通人的 AI 提示词模板库和轻量使用指南。每个模板都配有可直接运行的调用脚本，开箱即用。
